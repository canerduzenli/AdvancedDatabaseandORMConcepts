...
namespace AdvancedDatabaseandORMConcepts.Controllers
{
    public class ArtistsController : Controller
    {
        ...
        public ArtistsController(FullStackMusicContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Artists != null ? 
                          ...
                          Problem("Entity set 'FullStackMusicContext.Artists'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'FullStackMusicContext.Artists'  is null.");
            }
            var artist = await _context.Artists.FindAsync(id);
            if (artist != null)
            {
