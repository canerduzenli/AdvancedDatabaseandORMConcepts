...
namespace AdvancedDatabaseandORMConcepts.Controllers
{
    ...
    {
        private readonly DataAnnotationContext _context;

        public ClientsController(DataAnnotationContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Clients != null ? 
                          ...
                          Problem("Entity set 'DataAnnotationContext.Clients'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DataAnnotationContext.Clients'  is null.");
            }
            var client = await _context.Clients.FindAsync(id);
            if (client != null)
            {
