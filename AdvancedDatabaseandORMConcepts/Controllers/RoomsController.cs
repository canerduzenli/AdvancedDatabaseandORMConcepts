...
namespace AdvancedDatabaseandORMConcepts.Controllers
{
    public class RoomsController : Controller
    {
        ...
        public RoomsController(DataAnnotationContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Rooms != null ? 
                          ...
                          Problem("Entity set 'DataAnnotationContext.Rooms'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DataAnnotationContext.Rooms'  is null.");
            }
            var room = await _context.Rooms.FindAsync(id);
            if (room != null)
            {
