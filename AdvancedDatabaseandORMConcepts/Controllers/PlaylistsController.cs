...
namespace AdvancedDatabaseandORMConcepts.Controllers
{
    public class PlaylistsController : Controller
    {
        ...
        public PlaylistsController(FullStackMusicContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Playlists != null ? 
                          ...
                          Problem("Entity set 'FullStackMusicContext.Playlists'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'FullStackMusicContext.Playlists'  is null.");
            }
            var playlist = await _context.Playlists.FindAsync(id);
            if (playlist != null)
            {
